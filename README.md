...
[`v1.0.5 Android Preview`](https://github.com/ChristoGoodrich/2KBigRedFlowers/releases/tag/v1.0.5)
HyperOS-inspired mobile UI and version-center update.
...
| Android | [Download debug APK](https://github.com/ChristoGoodrich/2KBigRedFlowers/releases/download/v1.0.5/2KBigRedFlowers-1.0.5-debug.apk) | Latest debug-signed sideload preview |
...
| Android checksums | [Download Android SHA-256 manifest](https://github.com/ChristoGoodrich/2KBigRedFlowers/releases/download/v1.0.5/SHA256SUMS.txt) | Verify the Android preview APK |
