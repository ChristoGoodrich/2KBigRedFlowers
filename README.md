...
[`v1.0.2 Android Preview`](https://github.com/ChristoGoodrich/2KBigRedFlowers/releases/tag/v1.0.2)
...
| Android | [Download debug APK](https://github.com/ChristoGoodrich/2KBigRedFlowers/releases/download/v1.0.2/2KBigRedFlowers-1.0.2-debug.apk) | Latest debug-signed sideload preview |
...
| Android checksums | [Download Android SHA-256 manifest](https://github.com/ChristoGoodrich/2KBigRedFlowers/releases/download/v1.0.2/SHA256SUMS.txt) | Verify the Android preview APK |
