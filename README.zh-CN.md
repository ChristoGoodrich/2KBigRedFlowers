...
| Android | [下载 debug APK](https://github.com/ChristoGoodrich/2KBigRedFlowers/releases/download/v1.0.2/2KBigRedFlowers-1.0.2-debug.apk) | 最新 debug 证书签名侧载预览版 |
...
| Android 校验文件 | [下载 Android SHA-256 清单](https://github.com/ChristoGoodrich/2KBigRedFlowers/releases/download/v1.0.2/SHA256SUMS.txt) | 用于核验 Android 预览版 APK |
